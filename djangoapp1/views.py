...
class CustomerViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # value = self.request.query_params.get('active',None)
        # status = True if value=='True' else False
        ...
        if address:
            customers = Customer.objects.filter(active=status,address__icontains=address)
        else:
